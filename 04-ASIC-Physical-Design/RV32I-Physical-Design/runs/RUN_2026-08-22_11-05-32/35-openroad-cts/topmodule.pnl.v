module topmodule (clk,
 ...
 sky130_fd_sc_hd__nand4_2 _3547_ (.A(net1812),
    ...
    .VPWR(VPWR),
    .Y(_0906_));
 sky130_fd_sc_hd__a32oi_2 _3548_ (.A1(net2110),
    .A2(_0857_),
    .A3(\U_rf0.rd[2][1] ),
    .B1(net2109),
    .B2(\U_rf0.rd[10][1] ),
 ...
 sky130_fd_sc_hd__mux2_2 _4840_ (.A0(\u_wm0.u_dm.data_mem[10][31] ),
    ...
    .VPWR(VPWR),
    .X(_2053_));
 sky130_fd_sc_hd__and3_2 _4842_ (.A(net2092),
    .B(net1356),
    .C(_1847_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a311oi_2 _6084_ (.A1(net1834),
    ...
    .VPWR(VPWR),
    .Y(_2902_));
 sky130_fd_sc_hd__a211o_2 _6085_ (.A1(net2076),
    .A2(net1474),
    .B1(net1535),
    .C1(_2902_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout106 (.A(instruct_en),
    ...
    .VPWR(VPWR),
    .X(net106));
 sky130_fd_sc_hd__clkbuf_2 max_cap2102 (.A(_2573_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap2107 (.A(_1213_),
    ...
    .VPWR(VPWR),
    .X(net2107));
 sky130_fd_sc_hd__clkbuf_2 max_cap2108 (.A(_0837_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net2108));
 sky130_fd_sc_hd__clkbuf_2 max_cap2110 (.A(_0856_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2074 (.A(net2074),
    ...
    .VPWR(VPWR),
    .X(result[13]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2075 (.A(net1150),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net2075));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2076 (.A(net2076),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2077 (.A(net2077),
    ...
    .VPWR(VPWR),
    .X(result[16]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2078 (.A(net2078),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(result[17]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2079 (.A(net2079),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(result[18]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2080 (.A(net2080),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2081 (.A(net2081),
    ...
    .VPWR(VPWR),
    .X(result[1]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2082 (.A(net2082),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(result[20]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2083 (.A(net2083),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(result[21]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2084 (.A(net2084),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(result[22]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2085 (.A(net2085),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(result[23]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2086 (.A(net2086),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(result[24]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2087 (.A(net2087),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(result[25]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2088 (.A(net2088),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(result[26]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2089 (.A(net2089),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(result[27]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2090 (.A(net2090),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(result[28]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2091 (.A(net2091),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(result[29]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2092 (.A(net2092),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(result[2]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2093 (.A(net2093),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(result[30]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output2094 (.A(net2094),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 place1325 (.A(net1326),
    ...
    .VPWR(VPWR),
    .X(net1325));
 sky130_fd_sc_hd__buf_2 place1326 (.A(net2102),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 place1329 (.A(net1330),
    ...
    .VPWR(VPWR),
    .X(net1329));
 sky130_fd_sc_hd__buf_2 place1330 (.A(net2102),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 place1764 (.A(net1765),
    ...
    .VPWR(VPWR),
    .X(net1764));
 sky130_fd_sc_hd__buf_4 place1765 (.A(net2108),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 place1841 (.A(net2110),
    ...
    .VPWR(VPWR),
    .X(net1841));
 sky130_fd_sc_hd__buf_2 place1842 (.A(net2110),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 wire2104 (.A(_0950_),
    ...
    .VPWR(VPWR),
    .X(net2104));
 sky130_fd_sc_hd__clkbuf_2 wire2109 (.A(_0859_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
